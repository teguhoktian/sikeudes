...
class CreatePenganggaranBelanjasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('penganggaran_belanja', function (Blueprint $table) {
            // $table->id();
        ...
        Schema::table('penganggaran_belanja', function (Blueprint $table) {
    ...
    {
        Schema::table('penganggaran_belanja', function (Blueprint $table) {
            $table->dropForeign('penganggaran_belanja_id_sumber_dana_foreign');
            $table->dropForeign('penganggaran_belanja_id_penganggaran_kegiatan_foreign');
            $table->dropForeign('penganggaran_belanja_id_penganggaran_tahun_foreign');
            $table->dropForeign('penganggaran_belanja_id_rekening_objek_foreign');
        });
        Schema::dropIfExists('penganggaran_belanja');
    }
}
