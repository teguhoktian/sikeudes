...
class CreatePenganggaranPendapatansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('penganggaran_pendapatan', function (Blueprint $table) {
            // $table->id();
        ...
        Schema::table('penganggaran_pendapatan', function (Blueprint $table) {
    ...
    {
        Schema::table('penganggaran_pendapatan', function (Blueprint $table) {
            $table->dropForeign('penganggaran_pendapatan_id_sumber_dana_foreign');
            $table->dropForeign('penganggaran_pendapatan_id_rekening_objek_foreign');
            $table->dropForeign('penganggaran_pendapatan_id_penganggaran_tahun_foreign');
        });
        Schema::dropIfExists('penganggaran_pendapatan');
    }
}
