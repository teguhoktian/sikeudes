...
class PenganggaranPembiayaanBelanja extends Model
{
    use HasFactory, Uuid;
    protected $fillable = ['id_penganggaran_tahun', 'id_rekening_objek', 'id_sumber_dana', 'uraian', 'volume', 'satuan', 'harga_satuan'];
    protected $table = 'penganggaran_pembiayaan_belanja';
    protected $keyType = 'string';
    public $incrementing = false;
    /**
     * Get the sumber_dana that owns the PenganggaranPembiayaanBelanja
     *
    ...
    /**
     * Get the rekening_objek that owns the PenganggaranPembiayaanBelanja
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    ...
    /**
     * Get the tahun_anggaran that owns the PenganggaranPembiayaanBelanja
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
