        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <p class="text-muted m-b-30 font-13">
                    {{ __('Update Data Pembiayaan Belanja') }}
                </p>

                <div class="row">
                    <div class="col-md-12">
                        {{ Form::model($biayaBelanja, [ 'route' => ['penganggaran.biaya-belanja.update', $biayaBelanja->id], 'autocomplete' => 'off', 'method' => 'PATCH', 'enctype' => 'multipart/form-data' ]) }}
                        ...
                        <a href="{{ route('penganggaran.biaya-belanja.index', ['tahun_anggaran' => $biayaBelanja->tahun_anggaran->id]) }}" class="btn-danger btn">{{ __('Kembali') }}</a>
                        </form>
                    </div>
                </div>
            </div>
