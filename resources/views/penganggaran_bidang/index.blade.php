...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Penganggaran Bidang') }} : {{ Auth::user()->desa->nama }}</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li>
                        <a href="/">{{ __('Beranda') }}</a>
                    </li>
                    <li>
                        <a href="/">{{ __('Penganggaran Bidang') }} </a>
                    </li>
                    <li class="active">
                        {{ __('Penganggaran Bidang') }}
                    </li>
                </ol>
    ...
    <div class="row">
        {!! Form::open(['route' => ['penganggaran.bidang.destroy', ["tahun_anggaran" => $tahunAnggaran->id]], 'id' => 'deleteForm']) !!}
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("penganggaran.bidang.create", ["tahun_anggaran" => $tahunAnggaran->id])}}';
        var IndexRoute = '{{ route("penganggaran.bidang.index", ["tahun_anggaran" => $tahunAnggaran->id]) }}';
        var routeUp = '{{ route("bidang.tahun-anggaran.index") }}';
