    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                {!! Form::open(['route' => ['penganggaran.bidang.store', ['tahun_anggaran' => $tahunAnggaran->id]], 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                ...
                <a href="{{ route('penganggaran.bidang.index', ['tahun_anggaran' => $tahunAnggaran->id]) }}" class="btn-danger btn">{{ __('Kembali') }}</a>
                </form>
            </div>
        </div>
    </div>
