@if(Route::is('rekening-jenis.edit'))
<div class="form-group row {{ $errors->has('id_kelompok') ? ' has-error' : '' }}">
    <label class="col-sm-3 col-md-3 col-lg-2" for="inputName">{{ __('Bidang') }}</label>
    <div class="col-sm-9 col-md-9 col-lg-10">
        {{ Form::select('id_kelompok', $kelompoks, null, ['id' => 'select2', 'class' => 'form-control form-control-sm ' . ($errors->has('id_kelompok') ? ' is-invalid' : '')]) }}
        @error('id_kelompok')
