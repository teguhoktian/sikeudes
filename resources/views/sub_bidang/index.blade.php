...
<div class="container">
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">
                    <b>{{ __('Bidang') }} : {{ $bidang->kode }} - {{ $bidang->nama }}</b>
                </h4>
                <p class="text-muted font-13 m-b-30">
                    Data Bidang {{ $bidang->nama }} berisi <code>nama, kode, dan kabupaten</code>.
                </p>
    ...
    <div class="row">
        {!! Form::open(['route' => ['sub-bidang.destroy', ['bidang' => $bidang->id]], 'id' => 'deleteForm']) !!}
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("sub-bidang.create", ["bidang" => $bidang->id])}}';
        var IndexRoute = '{{ route("sub-bidang.index", ["bidang" => $bidang->id]) }}';
