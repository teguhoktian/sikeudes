...
<div class="container">
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">
                    <b>{{ __('Provinsi') }} : {{ $kabupaten->provinsi->kode }} - {{ $kabupaten->provinsi->nama }}</b><br />
                    <b>{{ __('Kabupaten') }} : {{ $kabupaten->kode }} - {{ $kabupaten->nama }}</b>
                </h4>
                <p class="text-muted font-13 m-b-30">
                    Data Kecamatan di Provinsi {{ $kabupaten->provinsi->nama }}, {{ $kabupaten->nama }} berisi <code>nama, kode, dan kabupaten</code>.
                </p>
    ...
    <div class="row">
        {!! Form::open(['route' => ['kecamatan.destroy', ['kabupaten' => $kabupaten->id]], 'id' => 'deleteForm']) !!}
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("kecamatan.create", ["kabupaten" => $kabupaten->id])}}';
        var IndexRoute = '{{ route("kecamatan.index", ["kabupaten" => $kabupaten->id]) }}';
