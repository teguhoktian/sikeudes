...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Desa') }}</h4>
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">
                    <b>{{ __('Provinsi') }} : {{ $kecamatan->kabupaten->provinsi->kode }} - {{ $kecamatan->kabupaten->provinsi->nama }}</b><br />
                    <b>{{ __('Kabupaten') }} : {{ $kecamatan->kabupaten->kode }} - {{ $kecamatan->kabupaten->nama }}</b><br />
                    <b>{{ __('Kecamatan') }} : {{ $kecamatan->kode }} - {{ $kecamatan->nama }}</b>
                </h4>
                <p class="text-muted font-13 m-b-30">
                    Data Desa di Provinsi {{ $kecamatan->kabupaten->provinsi->nama }}, {{ $kecamatan->kabupaten->nama }} , {{ $kecamatan->nama }}, berisi <code>nama, kode, dan kabupaten</code>.
                </p>
    ...
    <div class="row">
        {!! Form::open(['route' => ['desa.destroy', ['kecamatan' => $kecamatan->id]], 'id' => 'deleteForm']) !!}
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("desa.create", ["kecamatan" => $kecamatan->id])}}';
        var IndexRoute = '{{ route("desa.index", ["kecamatan" => $kecamatan->id]) }}';
