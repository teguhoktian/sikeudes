...
<div class="container">
        ...
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">
                    <b>{{ __('Bidang') }} : {{ $subBidang->bidang->kode }} - {{ $subBidang->bidang->nama }}</b>
                    <br />
                    <b>{{ __('Sub Bidang') }} : {{ $subBidang->kode }} - {{ $subBidang->nama }}</b>
                </h4>
                <p class="text-muted font-13 m-b-30">
                    Data Bidang {{ $subBidang->bidang->nama }}, Sub Bidang {{ $subBidang->nama }} berisi <code>nama, kode, dan kabupaten</code>.
                </p>
    ...
    <div class="row">
        {!! Form::open(['route' => ['kegiatan.destroy', ['sub_bidang' => $subBidang->id]], 'id' => 'deleteForm']) !!}
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("kegiatan.create", ["sub_bidang" => $subBidang->id])}}';
        var IndexRoute = '{{ route("kegiatan.index", ["sub_bidang" => $subBidang->id]) }}';
