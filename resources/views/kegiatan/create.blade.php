    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::open(['route' => ['kegiatan.store', 'sub_bidang' => $subBidang->id], 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                        @include('kegiatan.form')
                        <button class="btn btn-primary" type="submit"><i class="mdi mdi-content-save"></i> {{ __('Simpan') }}</button>
                        <a href="{{ route('kegiatan.index', ['sub_bidang' => $subBidang->id]) }}" class="btn-danger btn">{{ __('Kembali') }}</a>
                        </form>
                    </div>
                </div>
            </div>
