    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                {!! Form::open(['route' => ['rpjmd.subbidang.store', $bidang->id], 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                ...
                <a href="{{ route('rpjmd.subbidang.index', ['bidang' => $bidang->id]) }}" class="btn-danger btn">{{ __('Kembali') }}</a>
                </form>
            </div>
        </div>
    </div>
