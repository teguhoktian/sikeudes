    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12">
                        {!! Form::open(['route' => ['penganggaran.kegiatan.store', 'sub_bidang' => $subBidang->id], 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <a href="{{ route('penganggaran.kegiatan.index', ['sub_bidang' => $subBidang->id]) }}" class="btn-danger btn">{{ __('Kembali') }}</a>
                        </form>
                    </div>
                </div>
            </div>
