        ...
        <div class="col-sm-12">
            <div class="card-box">
                ...
                <p class="text-muted m-b-30 font-13">
                    {{ __('Tambah Data Belanja') }}
                </p>

                <div class="row">
                    <div class="col-md-12">
                        {!! Form::open(['route' => ['penganggaran.belanja.store', 'tahun_anggaran' => $tahunAnggaran->id], 'autocomplete' => 'off', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <a href="{{ route('penganggaran.belanja.index', ['tahun_anggaran' => $tahunAnggaran->id]) }}" class="btn-danger btn">{{ __('Kembali') }}</a>
                        </form>
                    </div>
                </div>
            </div>
