    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Detail Penganggaran Belanja') }} - {{ Auth::user()->desa->nama }}</h4>
                <ol class="breadcrumb p-0 m-0">
                    ...
                    <li class="active">
                        {{ __('Detail Penganggaran Belanja') }}
                    </li>
                </ol>
...
<div class="row">
    {!! Form::open(['route' => ['penganggaran.belanja.destroy', ['tahun_anggaran' => $tahunAnggaran->id, 'rekening_objek' => $rekeningObjek->id]], 'id' => 'deleteForm']) !!}
    </form>
</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("penganggaran.belanja.create", ["tahun_anggaran" => $tahunAnggaran->id])}}';
        var IndexRoute = '{{ route("penganggaran.belanja.detail.index", ["tahun_anggaran" => $tahunAnggaran->id, "rekening_objek" => $rekeningObjek->id]) }}';
        var textAdd = '{{ __("Tambah Data") }}';
        var textDelete = '<i class="mdi mdi-delete-forever"></i> {{ __("Hapus") }}';
        var routeUp = '{{ route("penganggaran.belanja.index", ["tahun_anggaran" => $tahunAnggaran->id])}}';
