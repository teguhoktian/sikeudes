...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title"><b>{{ __('Provinsi ') }}: {{ $provinsi->kode }} - {{ $provinsi->nama }}</b></h4>
                <p class="text-muted font-13 m-b-30">
                    Data Kabupaten di Provinsi {{ $provinsi->nama }} berisi <code>nama, kode, dan provinsi</code>.
                </p>
    ...
    <div class="row">
        {!! Form::open(['route' => ['kabupaten.destroy', ['provinsi' => $provinsi->id]], 'id' => 'deleteForm']) !!}
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("kabupaten.create", ["provinsi" => $provinsi->id])}}';
        var IndexRoute = '{{ route("kabupaten.index", ["provinsi" => $provinsi->id]) }}';
