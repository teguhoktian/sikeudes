...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('Kepala Desa') }} - {{ Auth::user()->desa->nama }}</h4>
                <ol class="breadcrumb p-0 m-0">
                    <li>
                        <a href="/">{{ __('Beranda') }}</a>
                    </li>
                    <li>
                        <a href="/">{{ __('Kepala Desa') }} </a>
                    </li>
                    <li class="active">
                        {{ __('Kepala Desa') }}
                    </li>
    ...
    <div class="row">
        {!! Form::open(['route' => 'kepala-desa.destroy', 'id' => 'deleteForm']) !!}
        </form>
    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        var routeAdd = '{{route("kepala-desa.create")}}';
        var IndexRoute = '{{ route("kepala-desa.index") }}';
        ...
        table = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                data: 'tanggal_mulai_jabatan'
            }, {
                data: 'tanggal_akhir_jabatan'
            }, {
                data: 'aktif'
            }, {
                data: 'action',
