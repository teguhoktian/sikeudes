...
use App\Http\Controllers\PenganggaranBelanjaController;
...
use App\Http\Controllers\PenganggaranPembiayaanBelanjaController;
...
use App\Http\Controllers\PenganggaranTahunPembiayaanBelanjaController;
...
Route::middleware(['auth'])->prefix('desa')->group(function () {
    ...
    Route::prefix('penganggaran')->group(function () {
        ...
        Route::get('tahun/belanja', [PenganggaranTahunBelanjaController::class, 'index'])->name('belanja.tahun-anggaran.index');
        Route::post('{tahun_anggaran}/belanja/{rekening_objek}/destroys', [PenganggaranBelanjaController::class, 'destroys'])->name('penganggaran.belanja.destroy');
        Route::get('{tahun_anggaran}/belanja', [PenganggaranBelanjaController::class, 'index'])->name('penganggaran.belanja.index');
        Route::get('{tahun_anggaran}/belanja/create', [PenganggaranBelanjaController::class, 'create'])->name('penganggaran.belanja.create');
        Route::post('{tahun_anggaran}/belanja/store', [PenganggaranBelanjaController::class, 'store'])->name('penganggaran.belanja.store');
        ...
        Route::get('tahun/biaya-belanja', [PenganggaranTahunPembiayaanBelanjaController::class, 'index'])->name('biaya-belanja.tahun-anggaran.index');
        Route::post('{tahun_anggaran}/biaya-belanja/{rekening_objek}/destroys', [PenganggaranPembiayaanBelanjaController::class, 'destroys'])->name('penganggaran.biaya-belanja.destroy');
        Route::get('{tahun_anggaran}/biaya-belanja', [PenganggaranPembiayaanBelanjaController::class, 'index'])->name('penganggaran.biaya-belanja.index');
        Route::get('{tahun_anggaran}/biaya-belanja/create', [PenganggaranPembiayaanBelanjaController::class, 'create'])->name('penganggaran.biaya-belanja.create');
        Route::post('{tahun_anggaran}/biaya-belanja/store', [PenganggaranPembiayaanBelanjaController::class, 'store'])->name('penganggaran.biaya-belanja.store');
        Route::get('{biaya_belanja}/biaya-belanja/edit', [PenganggaranPembiayaanBelanjaController::class, 'edit'])->name('penganggaran.biaya-belanja.edit');
        Route::patch('{biaya_belanja}/biaya-belanja/update', [PenganggaranPembiayaanBelanjaController::class, 'update'])->name('penganggaran.biaya-belanja.update');
        Route::get('{tahun_anggaran}/biaya-belanja/{rekening_objek}/detail', [PenganggaranPembiayaanBelanjaController::class, 'detail'])->name('penganggaran.biaya-belanja.detail.index');
    });
});
